...
.. note::
   ...
   the functions in this module act as if the implementation was correct. For example::

       >>> is_variadic_generic(list)
       False

   Other times, the implementation *won't* let you do things that should be possible.
   For example, in python 3.6 it wasn't possible to parameterize a :class:`typing.ClassVar`
   more than once::
