...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            typing.Callable[["set"], "collections.defaultdict"],
            typing.Callable[[typing.Set], typing.DefaultDict],
        ),
    ],
)
...
if sys.version_info >= (3, 12):
    NewStyleTypeAlias = typing.Set  # Shut up the type checker
    # Use exec to prevent a syntax error in older versions
    exec("type NewStyleTypeAlias = typing.Set")

    def test_new_style_type_alias():
        assert to_python(NewStyleTypeAlias) is set
