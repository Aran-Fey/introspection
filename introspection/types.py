...
DataclassesKwOnly = object  # The stdlib couldn't even bother making `KW_ONLY` a class. Sigh.
Type_ = typing.Union[type, typing.TypeVar, ParameterizedGeneric, None, DataclassesKwOnly]
