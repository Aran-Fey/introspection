...
class Signature(inspect.Signature):
    ...
    :ivar return_annotation: The annotation for the return value, or :attr:`inspect.Signature.empty`
    """

    def __init__(self,
                 parameters: Union[List[Parameter], Dict[str, Parameter], None] = None,
                 return_annotation: object = inspect.Signature.empty
                 ):  # FIXME: figure out why sphinx-autodoc messes up these default values
        super().__init__(
            parameters,
    ...
    @classmethod
    @functools.lru_cache()
    def from_callable(cls, callable_: Callable, param_type: type = Parameter) -> 'Signature':
        """
